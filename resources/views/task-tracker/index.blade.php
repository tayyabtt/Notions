                                    ...
                                    <div class="absolute z-10 mt-1 bg-white border notion-border rounded-lg shadow-lg p-3 min-w-80">
                                        <form action="{{ route('teams.update', $currentTeam) }}" method="POST">
                                            ...
                                            <textarea name="description" rows="2" placeholder="Team description"
                                                      class="w-full px-2 py-1 border notion-border rounded focus:outline-none focus:ring-1 focus:ring-blue-500 text-sm mb-2 resize-none">Stay organized with tasks, your way.</textarea>
                                            <div class="flex justify-end space-x-2">
                                                <button type="button" onclick="this.closest('details').open = false" 
                                                        class="px-2 py-1 text-xs bg-gray-200 text-gray-700 rounded hover:bg-gray-300">Cancel</button>
                                                <button type="submit" class="px-2 py-1 text-xs bg-blue-500 text-white rounded hover:bg-blue-600">Save</button>
            ...
            <div class="px-3 py-4 ml-[10%]">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-2">
                        <a href="{{ route('task-tracker.index', array_merge(request()->query(), ['view' => 'all'])) }}" 
                        ...
                        <a href="{{ route('task-tracker.index', array_merge(request()->query(), ['view' => 'by_status'])) }}" 
                        ...
                        <a href="{{ route('task-tracker.index', array_merge(request()->query(), ['view' => 'my_tasks'])) }}" 
                            ...
                            <tr>
                                <th class="text-left font-normal w-60">
                                    <div class="flex items-center space-x-1 cursor-pointer hover:bg-gray-50 px-1 py-1 rounded" onclick="openNameEdit()">
                                        ...
                                        <span id="displayName" class="text-xs font-medium">Tayyab</span>
                                    </div>
                                </th>
